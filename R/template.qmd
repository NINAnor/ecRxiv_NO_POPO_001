...
The indicator 'pollinator potential' relates to the ecosystem characteristic 'Functionally important species and biophysical structures' in the Norwegian framework for ecological condition.
...
$$
where $I$ is the normalised indicator value, $X$ is the cell-level pollinator potential, $X_0$ is the minimum reference level (worst condition where there is no potential for pollinators), and $X_{100}$ is the maximum reference level (best condition). 
