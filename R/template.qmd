...
The indicator provides a spatial measure of pollinator potential that accounts for plant–pollinator relationships and can be compared among regions. The indicator value for 'pollinator potential' was 0.3 nationally, indicating an overall substantial reduction in ecological condition for pollinators. The spatial uncertainty of the indicator value was large, with around 1/6-1/5 of the indicator area being around indicator values of 0.6 or higher (would probably be good to show that, maybe as a violin plot or so?, now I just did som rough guesstimate based on 1 SD, which takes us to 0.3+0.2=0.5 representing roughly the 79th percentile). This result was largely consistent across the regions, but with slightly higher indicator values and uncertainty in Eastern and Southern Norway compared to the other regions.
