...
The indicator provides a spatial measure of pollinator potential that accounts for plant–pollinator relationships and can be compared among regions. The indicator value for 'pollinator potential' was 0.3 nationally, indicating an overall substantial reduction in ecological condition for pollinators. The spatial variability of the indicator value was large, with around 1/6-1/5 of the indicator area being around indicator values of 0.6 or higher. This result was largely consistent across the regions, but with slightly higher indicator values and uncertainty in Eastern and Southern Norway compared to the other regions.
This indicator is ready for use but further work needs to be done to propagate uncertainty from the underlying species distribution models and interaction data into the final indicator. 
